...
export default function CreateUserPage() {
  ...
  const modules = [
    ...
    { value: "lead_form_screen_1", label: "Lead Form - Screen 1" },
    { value: "lead_form_screen_2", label: "Lead Form - Screen 2" },
    { value: "lead_form_screen_3", label: "Lead Form - Screen 3" },
    { value: "lead_form_screen_4", label: "Lead Form - Screen 4" },
    { value: "lead_form_screen_5", label: "Lead Form - Screen 5" },
    { value: "lead_form_screen_6", label: "Lead Form - Screen 6" },
    { value: "lead_form_screen_7", label: "Lead Form - Screen 7" },
